    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium' >
            ...
            <div className='flex items-center gap-6'>
                <img onClick={() => { setShowSearch(true); navigate('/collection') }} className='w-4 cursor-pointer' src={assets.search_icon} alt="" />
                <div className='group relative'>
                    <img onClick={() => { navigate('/login') }} className='w-4 cursor-pointer' src={assets.profile_icon} alt="" />
                ...
                <Link to='/cart' className='relative'>
                    <img className='w-4 min-w-5' src={assets.cart_icon} alt="" />
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</p>
                </Link>
                <img onClick={() => setVisble(true)} className='w-4 cursor-pointer sm:hidden' src={assets.menu_icon} alt="" />
            </div>
